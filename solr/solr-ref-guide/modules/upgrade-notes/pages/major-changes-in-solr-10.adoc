...
* The metrics API supports filtering by metric attributes with `name`, `category`, `core`, `collection`, `shard`, `replica_type`, and `handler` parameters. Multiple values can be comma-separated.
